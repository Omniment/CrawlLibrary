...
void KalmanFilter::update(float theta, float gyro)
{
    ...
    // S = H P H.T + R
    this->multiply3((float*)H, (float*)this->priori_covariance,
        (float*)this->HT, 2, 3, 3, 2, (float*)this->S);
    this->S[0][0] += this->r1;
    this->S[1][1] += this->r2;
    ...
    this->subtract((float*)observation, (float*)this->estimated_observation, 2,
        1, (float*)this->e);
    ...
    this->multiply3((float*)this->K, (float*)this->S, (float*)this->KT, 3, 2,
        2, 3, (float*)this->covariance_modify);
