...
void KalmanFilter::update(float theta, float gyro)
{
    ...
    // P = F P F.T + Q
    this->multiply3((float *)F, (float *)this->posteriori_covariance, (float *)this->FT, 3, 3, 3, 3, (float *)this->priori_covariance);
    ...
    this->multiply3((float *)this->priori_covariance, (float *)this->HT, (float *)this->S_inverse, 3, 3, 2, 2, (float *)this->K);
    ...
    this->subtract((float *)this->priori_covariance, (float *)this->covariance_modify, 3, 3, (float *)this->posteriori_covariance);
}

float KalmanFilter::getTheta()
{
    return this->posteriori_state[0];
}

float KalmanFilter::getThetaDot()
{
    return this->posteriori_state[1];
}
